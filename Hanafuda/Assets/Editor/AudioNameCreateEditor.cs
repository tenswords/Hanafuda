...
/// </summary>
public static class AudioNameCreateEditor {

    private const string COMMAND_NAME = "Tools/Create/Audio_Name";        // コマンド名
    private const string EXPORT_PATH = "Assets/Scripts/Common/AudioNameManager.cs"; //作成したスクリプトを保存するパス
    ...
    public static void CreateScript() {
        ...
        builder.AppendLine("/// </summary>");
        builder.AppendFormat("namespace AudioName").AppendLine();
        builder.AppendLine("{");
